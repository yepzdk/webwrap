class Webwrap < Formula
  ...
  url "https://github.com/yepzdk/webwrap/releases/download/v0.5.0/webwrap-0.5.0-macos-universal.tar.gz"
  version "0.5.0"
  # From the release: webwrap-0.5.0-macos-universal.tar.gz.sha256
  ...
  test do
    assert_match "0.5.0", shell_output("#{bin}/webwrap --version")
  end
end
